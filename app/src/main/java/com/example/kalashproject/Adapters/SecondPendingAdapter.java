...
public class SecondPendingAdapter extends RecyclerView.Adapter<SecondPendingAdapter.ViewHolder>
{

    Context context;
    ArrayList<AllInspectionDataModelList> List =  new ArrayList<AllInspectionDataModelList>();

    public SecondPendingAdapter(Context context, ArrayList<AllInspectionDataModelList> list) {
