...
public class GRPOAdapter extends RecyclerView.Adapter<GRPOAdapter.ViewHolder> {
    Context context;
    ArrayList<AllInspectionDataModelList> List = new ArrayList<AllInspectionDataModelList>();

    public GRPOAdapter(Context context, ArrayList<AllInspectionDataModelList> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.grpoButton.setVisibility(View.VISIBLE);

        holder.grpoButton.setOnClickListener(new View.OnClickListener() {
            @Override
